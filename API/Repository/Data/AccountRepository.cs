...
namespace API.Repository.Data
{
    public class AccountRepository : GeneralRepository<MyContext, Account, int>
    {
        ...
        {
            Account dataAccount = CheckDataAccount(CheckDataEmployee(param).Id);
            return dataAccount;
        }

        public Account CheckDataAccount(String param)
        {
            Account respond = myContext.Accounts.Where(e => e.Username == param).FirstOrDefault();
            return respond;
        }
        ...
        public int Register(FormRegister registerForm) //use postman  to test
        {
            ...
            else
            {
                var emp = new Employee
                {
                    ...
                    DivisionId = registerForm.DivisionId
                };
